...
# 1. Synchronization between the extension database and installed extensions.
declare -la list_installed_exts
get_list_installed_extensions list_installed_exts
echo "List of already installed ext's: $(get_lenght_array list_installed_exts)"
array_dump list_installed_exts
# exit
declare -la total_list_exts
get_total_list_extensions total_list_exts
echo "Total list ext's: $(get_lenght_array total_list_exts)"
...
lenght_list_exts_for_uninstall=$(get_lenght_array list_exts_for_uninstall)
...
lenght_list_exts_for_install=$(get_lenght_array list_exts_for_install)
...
echo "Language and common ext's: $(get_lenght_array language_and_common_exts)"
...
echo "List ext's for disable: $(get_lenght_array list_exts_for_disable)"
